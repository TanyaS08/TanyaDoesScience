...
- I use [Adobe Color](https://color.adobe.com/create/color-wheel) to generate colour palettes, both from the colour wheel as well as extracting them from figures.
