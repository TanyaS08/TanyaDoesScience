...
<span class="btn btn-outline-primary btn-sm">
  <a style="text-decoration:none">{{< fa dna >}} Core research theme</a>
</span>
<br>

Ecological networks are often analyzed at a single scale, yet interactions emerge from a hierarchy of constraints operating across space, time, and organsation. This project investigates how large-scale metawebs give rise to realised interaction networks, and how this scaling process shapes observed network structure.
...
<span class="btn btn-outline-primary btn-sm">
  <a style="text-decoration:none">{{< fa seedling >}} Emerging ideas</a>
</span>
<span class="btn btn-outline-primary btn-sm">
